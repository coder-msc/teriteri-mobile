...
import {MSG_HEAD_TYPE, MsgCard, Response, SERVICE_ROUT, ViewMessage} from '../../../util/type'
...
import {commentSectionReplyShow, homeMessageList, homeMessageShowSize, ViewUserDynamicId} from "@/store/DataStore";
...
<template>
  <div id="view-user-brief"     :style="{ animation: (reMore==false)?' backgroundColorChange 3s infinite':''}"    @click="reMore=true" >
    ...
    <div id="view-user-body-user">
      <div class="user-name">{{ Obj.userName }} <span  style="font-size: 3.8rem;color: #b1b3b8;"> 点赞了我的评论</span>
